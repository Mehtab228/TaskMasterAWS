...
public final class Task implements Model {
  ...
  private Task(String id, String name, String description, Team team, StatusOfTask status, String s3ImageKey) {
    this.id = id;
    this.name = name;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String description, Team team, StatusOfTask status, String s3ImageKey) {
      super.id(id);
      super.name(name)
